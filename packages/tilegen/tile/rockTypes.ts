...
export type RockTypeDef = {
  ...
  mineableResourceAffinities: Partial<Record<string, number>>; // multipliers on base mineableResourceRates from PipelineConfig
};
...
export const rockTypes: RockTypeDef[] = [
  {
    ...
    permeability: 0.55,
    fertilityBase: 0.65,
    mineableResourceAffinities: { iron: 2.0, coal: 3.0, salt: 1.5 },
  },
  {
    id: 'limestone',
    permeability: 0.70,
    fertilityBase: 0.60,
    mineableResourceAffinities: { iron: 0.5, coal: 0.5, salt: 3.0, gems: 0.8 },
  },
  {
    id: 'granite',
    permeability: 0.20,
    fertilityBase: 0.25,
    mineableResourceAffinities: { gold: 2.5, gems: 1.5, iron: 0.3 },
  },
  {
    id: 'basalt',
    permeability: 0.45,
    fertilityBase: 0.80,
    mineableResourceAffinities: { iron: 1.5, sulfur: 2.0, gold: 0.8, gems: 0.5 },
  },
  {
    id: 'metamorphic',
    permeability: 0.30,
    fertilityBase: 0.45,
    mineableResourceAffinities: { gold: 1.5, gems: 3.0, iron: 0.8 },
  },
];
